...
rem "PromoteAuthoringToLive" can be used to promote the application.
rem "PromoteAuthoringToLive" exports configuration for dgraphs and for
rem assemblers as files.  These files are then applied to the live
rem dgraph cluster(s) and assemblers.
call %~dp0runcommand.bat PromoteAuthoringToLive run 2>&1
