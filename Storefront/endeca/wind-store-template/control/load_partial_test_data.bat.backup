...
set DATA_FILE_NAME=rs_partial_data.xml.gz
...
echo Loading %~dp0..\test_data\partial\%DATA_FILE_NAME% into %DATA_RS_NAME%
call %CAS_ROOT%\bin\recordstore-cmd.bat write -a %DATA_RS_NAME% -h %CAS_HOST% -p %CAS_PORT% -f %~dp0..\test_data\partial\%DATA_FILE_NAME%
